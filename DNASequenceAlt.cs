...
namespace DNATagger
{
    class DNASequenceAlt
    {
        ...
        private List<SequenceTagAlt> tags = new List<SequenceTagAlt>();
        private SequenceTrackAlt track;
        ...
        public DNASequenceAlt(String fasta, String src = "unknown") {
        ...
        public void draw(System.Windows.Forms.Panel canvas, Font font, bool showLetters) {
            ...
            foreach (SequenceTagAlt tag in tags) tag.bar.draw(canvas);
        }
        ...
        public void setTrack(SequenceTrackAlt track){
            this.track = track;
        }



        public SequenceTrackAlt getTrack() {
            return this.track;
        }
